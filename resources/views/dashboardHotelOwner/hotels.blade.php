        ...
        <div class="courses-page d-grid m-20 gap-20">
          ...
          <div class="course bg-white rad-6 p-relative">
           ...
           {{-- {{dd($hotel->cover_img)}} --}}
            ...
            <img class="cover w-full" src="{{url('http://localhost:8000/storage/imgs/'.$hotel->cover_img)}}" alt="" />
...
{{-- {{dd($hotel)}} --}}
              ...
              <a href="{{route('allRequests',['id'=>$hotel->id])}}" class="title bg-orange c-white btn-shape">Requests </a>

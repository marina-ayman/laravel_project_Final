            ...
            "> </p>
                    ...
                    <div class="tab">
                        <h6>Number Of Rooms U want</h6>
                          <p><input placeholder="Number Of Rooms" oninput="this.className = ''" type="number" name="n_of_room[]"></p>
                    ...
                    <div class="tab">
                        <h6>Number of Adults</h6>
                          <p><input placeholder="Number of Adults" oninput="this.className = ''" type="number" name="n_of_adults"></p>

                          <h6>Number of Childeren</h6>
                          <p><input placeholder="Number of Childeren" oninput="this.className = ''" type="number" name="n_of_childeren"></p>

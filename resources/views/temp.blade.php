			...
			<div class="row">
				<div class="col-12">
					<nav class="navbar navbar-expand-md navbar-light">
                        ...
                        @if(!Auth::user() || Auth::user()->Role->name == "user" || Auth::user())
...
{{-- <a class="nav-link" href="{{route('AdminDash')}}">MY AdminDash</a> --}}
								...
								<li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4 active">
									<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">M.U.T.E</a>
									<div class="dropdown-menu">
										<a class="dropdown-item" href="{{route("MUT.create")}}">Make UR Trip</a>

									</div>
								</li>
                              @if(!Auth::user())
								<li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4 active">
									<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">SignUp</a>
									<div class="dropdown-menu">
